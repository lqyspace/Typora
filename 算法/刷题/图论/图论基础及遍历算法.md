...
![img](https://labuladong.github.io/algo/images/图/0.jpg)
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210712477.jpeg)

用邻接表和邻接矩阵的存储方式如下：

![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210713437.jpeg)
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210716564.jpeg)
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210718736.jpeg)
...
**[学习数据结构和算法的框架思维](https://labuladong.github.io/algo/di-ling-zh-bfe1b/xue-xi-sua-01220/) 说过，各种数据结构被发明出来无非就是为了遍历和访问，所以「遍历」是所有数据结构的基础**。
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210746242.gif)
...
为什么有这个区别呢？这就是前文 [东哥带你刷二叉树（纲领篇）](https://labuladong.github.io/algo/di-ling-zh-bfe1b/dong-ge-da-334dd/) 中讲到的回溯算法和 DFS 算法的区别所在：回溯算法关注的不是节点，而是树枝。如果没印象了，强烈建议重新阅读前文。

对于回溯算法，我们需要在「树枝」上做选择和撤销选择：

![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210746796.jpeg)
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307210746834.jpeg)
...
当然，图还会有很多其他的有趣算法，比如 [二分图判定](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/er-fen-tu--73400/)，[环检测和拓扑排序](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/huan-jian--e36de/)（编译器循环引用检测就是类似的算法），[最小生成树](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/kruskal-zu-e6b5b/)，[Dijkstra 最短路径算法](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/dijkstra-s-6d0b2/) 等等，有兴趣的读者可以去看看，本文就到这了。
