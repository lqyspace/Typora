...
并查集的算法是专门针对 **动态连通性**的算法，也是最小生成树的前置知识。
...
![img](https://labuladong.github.io/algo/images/unionfind/2.jpg)
...
![img](https://labuladong.github.io/algo/images/unionfind/4.jpg)
...
![img](https://labuladong.github.io/algo/images/unionfind/5.jpg)
...
![img](https://labuladong.github.io/algo/images/unionfind/6.jpg)
...
![img](https://labuladong.github.io/algo/images/unionfind/9.gif)
...
![img](https://labuladong.github.io/algo/images/unionfind/10.jpeg)
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307240837460.jpeg)

> Note
>
> 这让我想起小时候玩的棋类游戏「黑白棋」，只要你用两个棋子把对方的棋子夹在中间，对方的子就被替换成你的子。可见，占据四角的棋子是无敌的，与其相连的边棋子也是无敌的（无法被夹掉）。

其实这个问题应该归为 [岛屿系列问题](https://labuladong.github.io/algo/di-san-zha-24031/bao-li-sou-96f79/yi-wen-mia-4f482/) 使用 DFS 算法解决：
...
class Solution {
    public void solve(char[][] board) {
        ...
        for(int i=1; i<m-1; i++){
            for(int j=1; j<n-1; j++){
                if(board[i][j] == 'O')
                    dfs(board, i, j, 'X');// 或者 建议：board[i][j] = 'X'; 减少递归
            }
        }
        // 再把边界的#变回来O
        for(int i=0; i<m; i++){
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202307240837241.jpeg)
