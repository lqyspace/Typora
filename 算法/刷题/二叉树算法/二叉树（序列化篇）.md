...
本文是承接 [东哥带你刷二叉树（纲领篇）](https://labuladong.github.io/algo/di-ling-zh-bfe1b/dong-ge-da-334dd/) 的第三篇文章，前文 [东哥带你刷二叉树（构造篇）](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-66994/dong-ge-da-172f0/) 带你学习了二叉树构造技巧，本文加大难度，让你对二叉树同时进行「序列化」和「反序列化」。
...
![img](https://labuladong.github.io/algo/images/二叉树序列化/dup-preorder.jpg)
...
![img](https://labuladong.github.io/algo/images/二叉树序列化/dup-inorder.jpg)
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202309041518718.jpeg)
...
前文 [学习数据结构和算法的框架思维](https://labuladong.github.io/algo/di-ling-zh-bfe1b/xue-xi-sua-01220/) 说过了二叉树的几种遍历方式，前序遍历框架如下：
...
![img](https://labuladong.github.io/algo/images/二叉树序列化/1.jpeg)
...
前文 [东哥带你刷二叉树（构造篇）](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-66994/dong-ge-da-172f0/) 说过，至少要得到前、中、后序遍历中的两种互相配合才能还原二叉树。那是因为前文的遍历结果没有记录空指针的信息。这里的 `nodes` 列表包含了空指针的信息，所以只使用 `nodes` 列表就可以还原二叉树。
...
![img](https://raw.githubusercontent.com/lqyspace/mypic/master/PicBed/202309041518912.jpeg)
...
![img](https://labuladong.github.io/algo/images/二叉树序列化/3.jpeg)
